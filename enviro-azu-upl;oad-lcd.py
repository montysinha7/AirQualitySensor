...
######################################################### CODE TO UPLOAD DATA TO AZURE###############################
conn_str = "CONNECTION STRING TO AZURE IOT HUB" 
MSG_SND = '{{"messageId": 100,"deviceId": "Raspberry Pi Web Client","temperature (C)": {temperature},"humidity (%)": {humidity},"pressure (hPa)":{pressure},"light (lux)":{light},"oxidied (kO)":{oxidised},"reduced (kO)":{reduced},"nh3 (kO)":{nh3},"pm1 (ug/,3)":{pm1},"pm25 (ug/,3)":{pm25},"pm10 (ug/,3)":{pm10}}}' 
...
async def iothub_client_telemetry_sample_run():
    try:  
        ...
        msg_txt_formatted = MSG_SND.format(temperature=temp, humidity=humidity, pressure=pressure, light=lux, oxidised=oxidised, reduced=reducing, nh3=nh3, pm1=pm1, pm25=pm25, pm10=pm10)  
